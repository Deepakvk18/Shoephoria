...
import { signInEmailMutation } from "@/queries/authqueries"

const SignInForm = () => {

    const [showPassword, setShowPassword] = useState(false)
    const signInMutation   = useMutation({
                                mutationFn: signInEmailMutation
                            })
    ...
    <div className="flex">
        ...
        <form onSubmit={signInForm.handleSubmit(onSubmit)} className="space-y-3 w-full md:min-w-[300px]">
            ...
            <div className="flex flex-col w-full justify-between items-center">
                ...
                <Button className="w-full rounded-sm" type="submit">Sign in with Email</Button>
